...
class RouteView extends Component {
  ...
  pictureToggleHandler = () => {
    const opposite = !this.state.pictureToggle;
    this.setState({
      pictureToggle: opposite
    });
  };
  saveRoute = () => {
        ...
        {this.state.route ? (
          <div className="line">
            <div className="info">
              ...
              <div className="info-line">
                <p className="emph">Grade:</p> <p>{this.state.route.rating}</p>
              </div>
              <div className="info-line">
                <p className="emph">Rating:</p>{" "}
                <p> {this.state.route.stars} Stars</p>
              </div>
              <div className="info-line-button">
                {this.state.route.imgSmallMed ? (
                  <button onClick={this.pictureToggleHandler} className="btn">
                    Show Picture
                  </button>
                ) : (
                  <p className="btn">No Picture Available</p>
                )}
              </div>
            </div>
